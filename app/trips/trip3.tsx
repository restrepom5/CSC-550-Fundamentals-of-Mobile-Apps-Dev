...
export default function HomeScreen() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
          source={{ uri:  userData[2].image}}
                style={styles.image}
            />
          <Text style={styles.title}>My Trip to {userData[2].destination}</Text>
          <Text style={styles.text}>{userData[2].date}</Text>
          <Text style={styles.text}>My favorite places were {userData[2].favorite}</Text>
