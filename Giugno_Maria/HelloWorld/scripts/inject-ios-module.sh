...
# Heuristic: pick the iOS app target folder (exclude Pods/build/workspaces)
...
echo "   then Add Files… and select the four files in $DEST (check 'Add to targets'). Make sure RCTNativeAppearance.mm is Objective-C++."